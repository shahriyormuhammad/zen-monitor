...
import { getAdvertisingProducts } from '@/server/analytics/advertising-products';
...
export const GET = apiRoute(async (request: Request) => {
  ...
  const payload = await getAdvertisingProducts(tenantId, parsedDateFrom, parsedDateTo);
