...
import { getAdvertisingDecisionCenter } from '@/server/analytics/advertising-decision-center';
...
export const GET = apiRoute(async (request: Request) => {
  ...
  const payload = await getAdvertisingDecisionCenter(tenantId, parsedDateFrom, parsedDateTo);
