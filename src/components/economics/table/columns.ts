...
export const COLUMNS: TemplateColumn[] = [
  ...
  { id: 'buyout', label: 'Ручной %\nвыкупа', align: 'right', minWidthClass: 'min-w-[112px]' },
  { id: 'buyout_auto', label: 'Автоматический %\nвыкупа', align: 'right', minWidthClass: 'min-w-[148px]' },
  { id: 'marketplace_fee_percent_1', label: 'Комиссия МП %', align: 'right', minWidthClass: 'min-w-[120px]' },
  { id: 'marketplace_logistics_avg', label: 'Логистика до\nклиента с ИЛ и ИРП', align: 'right', minWidthClass: 'min-w-[148px]' },
  { id: 'marketplace_storage_avg', label: 'Хранение за ед\nсреднее / день', align: 'right', minWidthClass: 'min-w-[144px]' },
  { id: 'marketplace_logistics_total', label: 'Итоговая логистика\nс % выкупа', align: 'right', minWidthClass: 'min-w-[156px]' },
...
export const COLUMN_HELP_HINTS: Record<string, string> = {
  ...
  buyout_auto: 'Авто-выкуп (%) из официальной WB-воронки. Используется только при истории SKU ≥ 30 дней, закрытых заказах ≥ 100 и доле незакрытых заказов ≤ 40%.',
  ...
  marketplace_logistics_avg: 'Логистика до клиента с ИЛ и ИРП = средняя forward-доставка по выбранным складам с учётом коэф склада и общего кабинетного ИЛ + цена до скидки WB × общий кабинетный ИРП. ИРП применяется только при ИЛ > 1; при ИЛ ≤ 1 действует только скидка/нейтральный ИЛ.',
  marketplace_storage_avg: 'Хранение за ед среднее / день = средняя дневная ставка хранения WB по выбранным складам.',
  marketplace_logistics_total: 'Итоговая логистика с % выкупа: (логистика до клиента с ИЛ и ИРП + (1−выкуп) × reverse) / (выкуп / 100). Reverse считается только от литража, без коэф склада, ИЛ и ИРП.',
...
export const COLUMN_FORMULA_HINTS: Record<string, string> = {
  ...
  buyout_auto: 'WB funnel buyoutPercent; авто только при history≥30д, closed≥100, open<=40%',
  marketplace_fee_rub: 'wb_price_before_discount * (marketplace_fee_percent_1/100)',
  marketplace_logistics_total: 'FBW: (логистика до клиента с ИЛ и ИРП + логистика от клиента × (1 - выкуп)) / (выкуп / 100); FBS: без ИРП',
