ALTER TABLE "raw_api_realization_reports"
  ADD COLUMN IF NOT EXISTS "srid" varchar(255) DEFAULT '' NOT NULL;
--> statement-breakpoint

CREATE INDEX IF NOT EXISTS "realization_tenant_srid_idx"
  ON "raw_api_realization_reports" ("tenant_id", "srid")
  WHERE "srid" <> '';
--> statement-breakpoint
