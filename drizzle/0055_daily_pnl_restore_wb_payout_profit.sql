-- Restore WB PnL operating base to the original payout formula.
-- Tax base remains buyer-paid retail_amount; only the erroneous seller-price
-- payout override from 0054 is reverted.
