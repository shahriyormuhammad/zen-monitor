-- Tax and profit use different WB bases:
--   tax_base_revenue    = buyer-paid amount after WB discount (retail_amount)
--   payout_before_cost  = seller price after seller discount minus WB fees
