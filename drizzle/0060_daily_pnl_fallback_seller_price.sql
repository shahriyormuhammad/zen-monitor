-- Keep WB for-pay as the primary payout source.
-- If WB does not send forPay/ppvz_for_pay, calculate payout from the seller
-- price after seller discount (retail_price_withdisc_rub), not from buyer-paid
-- retail_amount after WB SPP. Tax base remains buyer-paid retail_amount.
